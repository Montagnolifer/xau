...
export default function PrintOrderPage() {
  ...
  const generatePDF = async (orderData: OrderResponse) => {
    try {
      ...
      const opt = {
        margin: 0.5,
        filename: `producao-${clientName}-${orderDate}.pdf`,
      ...
      <div id="print-content" className="p-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold text-gray-800" style={{ fontFamily: 'Comfortaa, sans-serif' }}>PRODUÇÃO</h1>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-400">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-400 p-3 text-left font-bold">Produtos</th>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="font-medium flex items-center gap-2">
                          ...
                          {/* Ícones para custos adicionais */}
                          {order.additionalCosts?.some(cost => cost.type === 'box') && (
                            <div title="Caixa Personalizada">
                              <Package className="h-4 w-4 text-blue-600" />
                            </div>
                          )}
                          {order.additionalCosts?.some(cost => cost.type === 'personalization') && (
                            <div title="Personalização">
        ...
        {/* Tabela de Tamanhos */}
        <div className="mb-8">
          <h3 className="text-lg font-bold text-gray-800 mb-4" style={{ fontFamily: 'Comfortaa, sans-serif' }}>
            Grade de Tamanhos
          </h3>
          <table className="w-full border-collapse border border-gray-400">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-400 p-3 text-left font-bold">Produto</th>
                <th className="border border-gray-400 p-2 text-center font-bold">35</th>
                <th className="border border-gray-400 p-2 text-center font-bold">36</th>
                <th className="border border-gray-400 p-2 text-center font-bold">37</th>
                <th className="border border-gray-400 p-2 text-center font-bold">38</th>
                <th className="border border-gray-400 p-2 text-center font-bold">39</th>
                <th className="border border-gray-400 p-2 text-center font-bold">40</th>
            ...
            <tbody>
              ...
              <tr className="bg-gray-50 border-t-2 border-gray-600">
                ...
                {['35', '36', '37', '38', '39', '40'].map((size) => {
                  const totalForSize = order.products.reduce((sum, product) => {
                  ...
                  return (
                    <td key={size} className="border border-gray-400 p-2 text-center font-semibold">
                      {totalForSize > 0 ? totalForSize : '-'}
                    </td>
                  )
                })}
