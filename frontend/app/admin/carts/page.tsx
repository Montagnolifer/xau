                ...
                <CardContent className="p-5 space-y-4">
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-col md:items-end gap-2">
                      <div className="flex flex-col text-left text-xs text-slate-400 md:text-right">
                        <span>Itens: <span className="font-semibold text-slate-700">{cart.totalItems}</span></span>
                        <span>
                          Atualizado em{" "}
                          {format(referenceDate, "dd/MM/yyyy HH:mm", { locale: ptBR })}
                        </span>
                      </div>
